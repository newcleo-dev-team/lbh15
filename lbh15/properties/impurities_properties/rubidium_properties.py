...
class RubidiumVapourPressureLandolt1960(PropertyInterface):
        """
        Pure metallic *Rubidium Vapour Pressure* property class
        ...
        def correlation(self, T: float, p: float = atm,
            ...
            """
            Returns the value of the pure metallic *Rubidium Vapour Pressure* by
