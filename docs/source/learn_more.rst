...
Beyond its primary roles as target material and heat transfer medium, liquid metal in a spallation target also functions as a solvent and reaction
medium for nuclear reaction products, such as Polonium, Mercury, and other radionuclides. Addressing impurities in liquid metal spallation targets
and nuclear reactors is a critical step for several key reasons.

Firstly, the typical amounts and concentrations of impurities expected in different facilities, according to predictions using nuclear codes, vary
significantly. For instance, impurities range from several grams in the MEGAPIE project (800 kW, 850 kg of LBE, 123 days of irradiation) to kilograms
in an LBE-based European Spallation Source (5 MW, 10 tons of LBE, 40 years of irradiation). Such variations necessitate detailed scrutiny and management
strategies tailored to each specific scenario .

The volatilization of radioactive species is the most significant physicochemical process involving impurities generated by irradiation in a liquid metal
target or reactor pool. This process plays a dominant role in the assessment of radioactivity release under both normal operation and accident scenarios.
Initially, these products exist in atomically dispersed forms until they reach a saturation concentration and react to form compounds. The degree of dilution
and chemical interaction with the solvent (lead or LBE) can alter the thermodynamic activity of these species, thereby impacting the thermodynamic state of
the medium. Understanding solubility behavior is crucial for safe operation; however, obtaining comprehensive thermodynamic data for all possible species and
phases remains challenging due to the system's complexity .

Furthermore, the risks associated with radioactive contamination, the formation of insoluble compounds, and the volatilization of certain elements, such as
mercury, are pivotal to the safety of nuclear facilities. Experiments indicate that mercury concentration in the gas above LBE can be significant, especially
at high temperatures, underscoring the importance of monitoring and managing these impurities . Effective impurity management strategies are essential to
mitigate these risks and ensure the safe operation of nuclear facilities.

Additionally, regulatory and safety requirements mandate a thorough understanding of these impurities and their behaviors. For example, the safe operation
and licensing of liquid-metal-based nuclear facilities depend on a detailed understanding of the physicochemical processes involving impurities, which can
significantly influence the facility's safety and environmental impact .

In conclusion, a thorough understanding and management of impurities in liquid metal spallation systems are vital for ensuring radiological,
chemical, and structural safety. The ability to predict and mitigate the risks associated with the release of radioactivity under various
conditions is indispensable for the safe and efficient operation of nuclear installations.
